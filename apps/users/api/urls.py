...
urlpatterns = [
    ...
    path("auth/users/<int:user_id>/follow/", views.UserFollowAPIView.as_view(), name="user_follow"),
    path("auth/users/<int:user_id>/unfollow/", views.UserUnfollowAPIView.as_view(), name="user_unfollow"),
]
